...
//Codigo encargado de darle funcionalidad al botón de cambio de idioma
document.addEventListener('DOMContentLoaded', () => {
    const languageBtn = document.getElementById('change-language-btn');

    languageBtn.addEventListener('click', () => {
        // Redirige al documento en español
        window.location.href = '../indexEs.html';
    });

    console.log("English Pokedex loaded.");
});
